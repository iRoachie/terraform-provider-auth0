...
const testAccBotDetectionUpdatePartial = `
resource "auth0_attack_protection" "my_protection" {
	bot_detection {
		response {
			policy = "always_on"
...
const testAccBotDetectionUpdateFull = `
resource "auth0_attack_protection" "my_protection" {
	bot_detection {
		response {
			policy = "high_risk"
			selected = "recaptcha_enterprise"
			providers {
				recaptcha_v2 {
					secret = "someSecret"
					site_key = "someSiteKey"
...
const testAccBotDetectionDisable = `
resource "auth0_attack_protection" "my_protection" {
	bot_detection {
		response {
			policy = "off"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "suspicious_ip_throttling.#", "1"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.#", "1"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.0.%", "1"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.0.response.0.policy", "always_on"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.0.response.0.selected", "auth0"),
				),
			},
			{
				Config: testAccBotDetectionUpdatePartial,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "breached_password_detection.#", "1"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "brute_force_protection.#", "1"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "suspicious_ip_throttling.#", "1"),
					...
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.0.%", "1"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.0.response.0.policy", "always_on"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.0.response.0.selected", "recaptcha_v2"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.0.response.0.providers.0.recaptcha_v2.0.secret", "someSecret"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.0.response.0.providers.0.recaptcha_v2.0.site_key", "someSiteKey"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.0.response.0.providers.0.recaptcha_enterprise.#", "1"),
				),
			},
			{
				Config: testAccBotDetectionUpdateFull,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "breached_password_detection.#", "1"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "brute_force_protection.#", "1"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "suspicious_ip_throttling.#", "1"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.#", "1"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.0.%", "1"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.0.response.0.policy", "high_risk"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.0.response.0.selected", "recaptcha_enterprise"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.0.response.0.providers.0.recaptcha_v2.0.secret", "someSecret"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.0.response.0.providers.0.recaptcha_v2.0.site_key", "someSiteKey"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.0.response.0.providers.0.recaptcha_enterprise.0.api_key", "someApiKey"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.0.response.0.providers.0.recaptcha_enterprise.0.project_id", "someProjectId"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.0.response.0.providers.0.recaptcha_enterprise.0.site_key", "someSiteKey"),
				),
			},
			{
				Config: testAccBotDetectionDisable,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "breached_password_detection.#", "1"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "brute_force_protection.#", "1"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "suspicious_ip_throttling.#", "1"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.#", "1"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.0.%", "1"),
					resource.TestCheckResourceAttr("auth0_attack_protection.my_protection", "bot_detection.0.response.0.policy", "off"),
				),
			},
		},
	})
